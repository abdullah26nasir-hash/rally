...
export function AnalyticsConsent() {
  ...
  return <>
    ...
    {choice && !settings && <button className="fixed z-40 bottom-20 sm:bottom-1 right-2 min-h-11 px-3 text-[12px] text-graphite underline bg-paper/90 rounded-md" onClick={() => setSettings(true)}>Analytics settings</button>}
  </>;
}
